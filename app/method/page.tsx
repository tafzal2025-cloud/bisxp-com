...
const ARTIFACTS = [
  ...
  { name: 'CLAUDE.md', role: 'Standing Instructions', description: 'The permanent operating manual for every AI agent working on a project. Technology choices, forbidden patterns, quality gates, and non-negotiable rules \u2014 all defined once, enforced in every session.', proof: 'Consistent architecture patterns enforced across months of continuous development on a single platform \u2014 without a single regression from context loss.' },
